...
namespace DevWeb_23774_25961.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "A Palavra-passe e confirmação da Palavra-passe não coincidem.")]
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("A interface de utilizador padrão requer um armazenamento de utilizador com suporte de e-mail.");
            }
